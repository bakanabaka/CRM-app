...
Future<Uint8List> generatePdf1(
  ...
  final pageTheme = await _myPageTheme1(format);
...
Future<pw.PageTheme> _myPageTheme1(PdfPageFormat format) async {
  return pw.PageTheme(
...
Future<void> saveAsFile1(final BuildContext context, final LayoutCallback build,
...
void showPrintedToast1(final BuildContext context) {
  ScaffoldMessenger.of(context)
      .showSnackBar(const SnackBar(content: Text("Document printed successs")));
}

void showSharedToasted1(final BuildContext context) {
